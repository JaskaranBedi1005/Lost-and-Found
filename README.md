...
### [live demo](https://lost-and-found-7w37.vercel.app)
### API - https://lost-and-found-9.onrender.com
...
```bash
git clone https://github.com/JaskaranBedi1005/Lost-and-Found.git
cd Lost-and-Found
```
...
```
```python
The server will run on http://localhost:5000, and the client will be available at http://localhost:5173
```